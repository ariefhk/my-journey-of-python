...
class TimeWindow:
    def __init__(self, start: dt.datetime, end: dt.datetime, date_format: str = _DATE_FORMAT):
        self.start = start
        self.end = end
    ...
    def hourly_windows(self):
        ...
        while cursor < self.end:
            ...
            yield cursor.strftime(self.date_format), window_end.strftime(self.date_format)
            cursor += one_hour
